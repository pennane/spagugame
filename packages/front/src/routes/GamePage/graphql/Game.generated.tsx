...
export type NewGameMutation = { __typename?: 'Mutation', createOngoingGame: { __typename?: 'OngoingGame', _id: string, gameType: Types.GameType, processState: Types.OngoingGameProcessState, jsonState: string, currentTurn?: string | null, startedAt?: number | null, players: Array<{ __typename?: 'OngoingGamePlayer', score: number, userId: string }> } };
