...
export type ProfilePageUserPlayedGameFragment = { __typename?: 'PlayedGame', _id: string, gameType: Types.GameType, playerIds: Array<string>, playerScores: Array<number>, playerElosBefore: Array<number>, playerElosAfter: Array<number>, startedAt: Date, finishedAt: Date, finalState?: string | null, ongoingGameId?: string | null, players: Array<{ __typename?: 'User', _id: string, githubId: string, userName: string }> };

export type UserFollowingFragment = { __typename?: 'User', followers: Array<{ __typename?: 'User', _id: string, userName: string, githubId: string, profilePicture?: { __typename?: 'Image', url: string } | null }>, following: Array<{ __typename?: 'User', _id: string, userName: string, githubId: string, profilePicture?: { __typename?: 'Image', url: string } | null }> };

export type ProfilePictureFragment = { __typename?: 'Image', id: string, hash?: string | null, url: string };

export type ProfilePageUserFragment = { __typename?: 'User', _id: string, githubId: string, userName: string, profilePicture?: { __typename?: 'Image', id: string, hash?: string | null, url: string } | null, stats: Array<{ __typename?: 'UserStats', _id: string, userId: string, gameType: Types.GameType, totalWins: number, totalPlayed: number, elo: number }>, playedGames: Array<{ __typename?: 'PlayedGame', _id: string, gameType: Types.GameType, playerIds: Array<string>, playerScores: Array<number>, playerElosBefore: Array<number>, playerElosAfter: Array<number>, startedAt: Date, finishedAt: Date, finalState?: string | null, ongoingGameId?: string | null, players: Array<{ __typename?: 'User', _id: string, githubId: string, userName: string }> }>, achievements: Array<{ __typename?: 'Achievement', _id: string, name: string, description: string, criteria: { __typename?: 'LeaderboardRankUnlockCriteria', gameType?: Types.GameType | null, rank: number } | { __typename?: 'OtherUnlockCriteria', gameType?: Types.GameType | null } | { __typename?: 'TotalPlayedUnlockCriteria', gameType?: Types.GameType | null, played: number } | { __typename?: 'TotalWinsUnlockCriteria', gameType?: Types.GameType | null, wins: number } | { __typename?: 'WinStreakUnlockCriteria', gameType?: Types.GameType | null, streak: number } }>, followers: Array<{ __typename?: 'User', _id: string, userName: string, githubId: string, profilePicture?: { __typename?: 'Image', url: string } | null }>, following: Array<{ __typename?: 'User', _id: string, userName: string, githubId: string, profilePicture?: { __typename?: 'Image', url: string } | null }> };
...
export type FollowUserMutation = { __typename?: 'Mutation', toggleFollow: { __typename?: 'User', _id: string, followers: Array<{ __typename?: 'User', _id: string, userName: string, githubId: string, profilePicture?: { __typename?: 'Image', url: string } | null }>, following: Array<{ __typename?: 'User', _id: string, userName: string, githubId: string, profilePicture?: { __typename?: 'Image', url: string } | null }> } };
